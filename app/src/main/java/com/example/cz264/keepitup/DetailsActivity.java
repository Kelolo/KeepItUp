package com.example.cz264.keepitup;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView exerciseText = (TextView)findViewById(R.id.excersiseTitle);
        ...
        if (exerciseTitle.equalsIgnoreCase(MainActivity.EXERCISE_WEIGHTS)){
            ...
            mainBG.setBackgroundColor(Color.parseColor("#52ad56")); //#916bcd
